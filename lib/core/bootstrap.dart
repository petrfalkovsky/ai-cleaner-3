...
class Bootstrap {
  ...
  Future<void> initialize() async {
    final directory = HydratedStorageDirectory((await getTemporaryDirectory()).path);
...
Future<void> bootstrap(FutureOr<Widget> Function() builder, {required Flavor flavor}) async {
